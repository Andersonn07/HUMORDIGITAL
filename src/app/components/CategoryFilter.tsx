  ...
  return (
    <div className="bg-white/80 dark:bg-neutral-900/80 backdrop-blur-xl rounded-[2rem] border border-white/60 dark:border-neutral-700/50 p-6 transition-all duration-500 shadow-md hover:shadow-xl">
      <div className="flex items-center justify-between mb-5">
        <h3 className="text-base font-semibold text-neutral-900 dark:text-neutral-100">Categorias</h3>
        {!censorMode && (
      ...
      {!censorMode && matureCategory && (
        <div className="mt-6 pt-6 border-t border-neutral-200 dark:border-neutral-800">
          ...
          <button
            ...
            className={`w-full rounded-xl transition-all duration-200 active:scale-[0.98] overflow-hidden border ${
              selectedCategory === matureCategory.id
          ...
          >
            ...
            >
              ...
              <div className="flex-1 text-left min-w-0">
                <p className="font-bold text-sm">{matureCategory.name}</p>
                <p className={`text-xs mt-1 leading-relaxed ${selectedCategory === matureCategory.id ? 'text-red-100' : 'text-red-600 dark:text-red-400'}`}>
                  Sexualidade · Religião · Humor Negro Pesado — 29 piadas
                </p>
              </div>
              <div className={`flex-shrink-0 w-9 h-9 rounded-lg flex items-center justify-center text-xs font-bold border ${
                selectedCategory === matureCategory.id
