...
export function StickersTab({ stickers, onDeleteSticker }: StickersTabProps) {
  if (stickers.length === 0) {
    return (
      <div className="text-center py-16 bg-white dark:bg-neutral-900 rounded-2xl border border-neutral-200 dark:border-neutral-800 mt-6">
        <p className="text-neutral-500 dark:text-neutral-400 text-sm">Nenhum sticker guardado ainda. Crie o seu primeiro acima!</p>
      </div>
    );
  }
  ...
  return (
    <div className="mt-8">
      <h3 className="text-xl font-bold text-neutral-800 dark:text-neutral-100 mb-4">A tua coleção</h3>
